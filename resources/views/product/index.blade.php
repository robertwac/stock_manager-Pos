                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            @endcan
                            <li>
                                <a href="#all_stock_report_tab" data-toggle="tab" aria-expanded="true"><i
                                        class="fa fa-hourglass-half" aria-hidden="true">
                                    </i> @lang('All Stock Report')</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="all_stock_report_tab">

                                @include('product.partials.product_location_stock')
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',
                ...
                function() {
                    ...
                    if ($("#all_stock_report_tab").hasClass('active')) {
                        all_stock_report.ajax.reload();
                    }
                });
        ...
        // end changes
        $(document).ready(function () {
   all_stock_report= $('#all_stock_report').DataTable({
        processing: true,

                scrollY: "75vh",
                scrollX: true,
                ajax: {
                            url: '/product_location/business_location',
                           "data": function(d) {
                        d.type = $('#product_list_filter_type').val();
                        d.category_id = $('#product_list_filter_category_id').val();
                        d.brand_id = $('#product_list_filter_brand_id').val();
